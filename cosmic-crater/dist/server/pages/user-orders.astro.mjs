...
const $$UserOrders = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": `My Orders | ${SITE_TITLE}`, "description": `View your order history on ${SITE_TITLE}` })}${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <!-- SSR content - visible by default for SEO, hidden if user is logged in --> <div id="ssr-content"> <main class="mx-auto p-4"> <header class="mb-6"> <h1 class="text-3xl font-bold text-gray-900 mb-2">My Orders</h1> <p class="text-lg text-gray-700 mb-2">
Please sign in to view your order history.
</p> </header> </main> </div> <!-- SPA container - wrapper checks auth before rendering App --> <div id="spa-container" style="display: none;"> ${renderComponent($$result, "SSRAppWrapper", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/Users/chrisherre/Downloads/RivCoDelivery-RBAC 2/cosmic-crater/src/components/SSRAppWrapper.jsx", "client:component-export": "default" })} </div> ${renderComponent($$result, "Footer", $$Footer, {})} <!-- Client-side auth check --> ${renderScript($$result, "/Users/chrisherre/Downloads/RivCoDelivery-RBAC 2/cosmic-crater/src/pages/user-orders.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "/Users/chrisherre/Downloads/RivCoDelivery-RBAC 2/cosmic-crater/src/pages/user-orders.astro", void 0);

const $$file = "/Users/chrisherre/Downloads/RivCoDelivery-RBAC 2/cosmic-crater/src/pages/user-orders.astro";
